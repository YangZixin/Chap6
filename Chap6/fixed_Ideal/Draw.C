void IdealWave()
{
    ...
    TCanvas *c1 = new TCanvas("c1","Wave Propagation",200,10,600,600);
    c1->Divide(1,9);
    c1->cd(1);
    ...
    c1->cd(2);
    TGraph *gr05 = new TGraph("Time05.dat");
 	gr05->GetYaxis()->SetRangeUser(-0.05,1.05);
	gr05->SetLineColor(9);
    gr05->Draw("AC");
    ...
    TGraph *gr225 = new TGraph("Time225.dat");
 	gr225->GetYaxis()->SetRangeUser(-0.55,0.55);
	gr225->SetLineColor(9);
    gr225->Draw("AC");

	c1->cd(5);
    TGraph *gr5 = new TGraph("Time5.dat");
 	gr5->GetYaxis()->SetRangeUser(-0.55,0.55);
	gr5->SetLineColor(9);
    gr5->Draw("AC");

	c1->cd(6);
    TGraph *gr75 = new TGraph("Time75.dat");
 	gr75->GetYaxis()->SetRangeUser(-0.55,0.55);
	gr75->SetLineColor(9);
    gr75->Draw("AC");

	c1->cd(7);
    TGraph *gr90 = new TGraph("Time90.dat");
 	gr90->GetYaxis()->SetRangeUser(-1.05,0.05);
	gr90->SetLineColor(9);
    gr90->Draw("AC");

	c1->cd(8);
    TGraph *gr95 = new TGraph("Time95.dat");
 	gr95->GetYaxis()->SetRangeUser(-1.05,0.05);
	gr95->SetLineColor(9);
    gr95->Draw("AC");

	c1->cd(9);
    TGraph *gr100 = new TGraph("Time100.dat");
 	gr100->GetYaxis()->SetRangeUser(-1.05,0.05);
